; Custom NSIS template for Kotha with portable mode support.
...
Function PageInstallType
  ...
  ${NSD_CreateLabel} 44u 49u -44u 20u "Installs to your system with Start Menu shortcuts and an uninstaller."
  Pop $0
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Kotha for portable
...
Function .onInit
  ...
  ; --- PORTABLE MODE --- Auto-detect a Kotha portable install during updates.
  ${If} $PortableMode <> 1
  ${AndIf} $UpdateMode = 1
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Kotha Portable Mode"
    FileClose $0
