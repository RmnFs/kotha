...
define_class!(
    ...
    #[name = "KothaPasteProvider"]
    #[ivars = ProviderIvars]
    pub struct KothaPasteProvider;

    impl KothaPasteProvider {
...
struct MacPending {
    ...
    provider: Option<Retained<KothaPasteProvider>>,
    auto_submit: bool,
...
pub(super) fn run(
    ...
    let provider = KothaPasteProvider::new(state.clone(), text.to_string());
