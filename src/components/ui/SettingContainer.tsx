...
export const SettingContainer: React.FC<SettingContainerProps> = ({
  ...
  const horizontalContainerClasses = grouped
    ? "flex items-center justify-between min-h-14 gap-4 px-4 py-3"
    : "flex items-center justify-between min-h-14 gap-4 px-4 py-3 rounded-xl border border-border bg-surface";
