  ...
  return createPortal(
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`flex max-h-[calc(100dvh-2rem)] w-full max-w-lg flex-col overflow-hidden rounded-2xl border border-border bg-surface outline-none sm:max-h-[calc(100dvh-3rem)] ${className}`}
      >
